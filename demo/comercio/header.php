			...
			<div class="container-fluid custom-container menu-rel-container">
				<div class="row">
					...
					<div class="col-lg-12 col-xl-7 order-lg-3 order-xl-2 menu-container">
						<div class="mainmenu">
							<ul id="navigation">
								<li class="has-child "><a href="index.php" class="active">home</a>
								</li>
								<li class="has-child "><a href="collection.php">Collections</a>
									<ul class="sub-menu">
								...
								<li class="has-child"><a href="shop.html">Accessories</a>
									<ul class="sub-menu">
